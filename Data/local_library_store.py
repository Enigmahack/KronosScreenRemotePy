...
def _selftest() -> None:
    ...
    try:
        ...
        # exists to back) ──
        import Data.changeset_sync as _csync
        from Data.librarian_sysex import OBJ_PROGRAM as _OBJ_PROGRAM
        from Commands.session_dependency_clipboard import SessionDependencyClipboard as _Clipboard
        from Data.pcg_file import WIRE_SIZE_EXI as _WIRE_SIZE_EXI
