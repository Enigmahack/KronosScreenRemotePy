...
from Data.librarian_model import BatchPlacement, ObjLoc, SequentialFillItem, resolve_sequential_fill
...
def _selftest() -> None:
    import sys
    from Data.librarian_sysex import OBJ_COMBI, OBJ_PROGRAM
