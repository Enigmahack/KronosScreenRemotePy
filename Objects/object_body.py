...
def _combi_all_timbres_at_default(body: bytes) -> bool:
    ...
    try:
        from Data.librarian_sysex import _TIMBRE_COUNT, iter_combi_timbre_refs
        seen = 0
...
def setlist_body_is_init(body: bytes) -> bool:
    ...
    try:
        from Data.librarian_sysex import iter_setlist_slot_refs
...
def _setlist_slot_name(body: bytes, slot: int) -> str:
    ...
    try:
        from Tools.setlist_data import _SLOT_BASE, _SLOT_SIZE, _NAME_LEN
...
def _selftest() -> None:
    ...
    from Data.librarian_sysex import set_combi_timbre_ref
