...
from Data.merge_cache import MergeCache, MergeEntry, MergeRefSite
from Data.pcg_file import PcgFile, PcgObjectEntry, WIRE_SIZE_EXI, open_pcg, wire_body_from_pcg_entry
from Commands.session_dependency_clipboard import SessionDependencyClipboard, SessionDependencyEntry
from Utils.setlist_colors import ALL_COLORS as SETLIST_COLORS, get_by_index_or_default as setlist_color
...
class LibrarianShellWindow(QDialog):
    ...
    def __init__(self, host: str, service: Optional[SysExService],
        ...
        self._oplog = OpLog()
        from Data.merge_cache import MergeCacheBehavior
        ...
        from Data.librarian_undo import LibrarianUndoRecorder
    ...
    def _warm_category_names(self, host: str) -> None:
        ...
        try:
            ...
            if dump is None:
                return
            from Objects.global_body import read_category_names
...
def _selftest() -> None:
    ...
    from Core.kronos_sysex import BankId
